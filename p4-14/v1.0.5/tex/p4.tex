...
If multiple calculated fields exist, the order in which the fields are updated or
verified is target specific.
...
\end{itemize}
\item Calculated fields (Section \ref{sec:checksums})
\begin{itemize}
\item If multiple calculated fields exist, the order in which the fields are updated or
verified is target specific.
\end{itemize}
\end{itemize}
